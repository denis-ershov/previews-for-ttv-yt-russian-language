# 🇷🇺 Русский язык для Previews (For Twitch & YouTube & Kick)

Пользовательский скрипт версии `1.0.1` для Tampermonkey, Greasemonkey и Violentmonkey, который добавляет русский язык в настройки браузерного расширения **"Previews (For Twitch & YouTube & Kick)"**.

## 📋 Описание

Этот userscript автоматически добавляет опцию `Русский` в селектор языков в панели настроек расширения "Previews (For Twitch & YouTube & Kick)". Скрипт оптимизирован для стабильной работы в популярных менеджерах пользовательских скриптов и отслеживает динамическое появление панели настроек на поддерживаемых сайтах.
...
- **Оригинальное расширение**: "Previews (For Twitch & YouTube & Kick)"
...
1. Убедитесь, что расширение "Previews (For Twitch & YouTube & Kick)" установлено
...
- [Расширение Previews (For Twitch & YouTube & Kick)](https://previews-app.com/) - Оригинальное расширение
...
**Примечание**: Это неофициальный пользовательский скрипт и не связан с разработчиками оригинального расширения "Previews (For Twitch & YouTube & Kick)".
